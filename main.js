    ...
    refreshLayers: function () { 
        ...
        for (var i = 0, layer; layer = this.layers[i]; i++) { 
            ...
            (function(t, n) { 
                ...
                layer.addEventListener ("mousedown", function (e1){
                    console.log(e1.stageX + " " + e1.stageY);
                ...
                layer.on("pressmove", function(evt) { 
                       ...
                       // console.log(offset.x + " " + offset.y + " " + e2.stageX + " " + e2.stageY);
                        if (self.tool == TOOL_MOVE) { 
                            evt.target.x  = offset.x + evt.stageX; 
                            evt.target.y = offset.y + evt.stageY; 
                        } 
                });
